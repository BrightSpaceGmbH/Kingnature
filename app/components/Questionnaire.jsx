...
export default function Questionnaire() {
    ...
    return (
        <section className="py-16 px-6 min-h-screen flex items-start justify-center" id="questionnaire">
            <div className="max-w-4xl w-full bg-white rounded-2xl p-8 shadow-xl">
                {/* Progress Bar */}
                {step <= 6 && (
                    <div className="mb-8">
